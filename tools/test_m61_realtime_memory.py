...
def size_output(ram_bss: int, nocache: int = 1816, skip: int = 1824) -> str:
...
def main() -> int:
    ...
    assert static_bytes == 1824 + 104964 + 2208 + 150000 + 4108
    ...
    assert static_bytes == 2048 + 104964 + 2208 + 150000 + 4108

    limit = gate.RAM_CAPACITY_BYTES * gate.RAM_LIMIT_PERCENT // 100
    fixed = 1824 + 104964 + 2208 + 4108 + gate.CONTINGENCY_BYTES
