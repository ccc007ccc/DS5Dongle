#!/usr/bin/env python3
"""Build and run the pure M61 stick-deadzone host tests through WSL."""
...
def main() -> int:
    ...
    test = ROOT / "tools" / "test_m61_stick_deadzone.c"
    source = project / "m61_stick_deadzone.c"
    output = "/tmp/m61-stick-deadzone-test"
    command = (
        "set -eu; "
